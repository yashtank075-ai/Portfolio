...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050914] text-slate-100 dark:bg-[#050914] dark:text-slate-100 border-t border-white/10 pt-16 pb-12 relative transition-colors duration-300">
