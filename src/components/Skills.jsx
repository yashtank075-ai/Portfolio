  ...
  return (
    <section id="skills" className="py-20 lg:py-28 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16 p-6 sm:p-8 rounded-3xl bg-white/70 dark:bg-[#080d19]/80 border border-slate-200 dark:border-white/10 backdrop-blur-xl shadow-xl text-left space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center font-mono text-xs">
            ...
            {/* Step 1: User */}
            <div className="p-4 rounded-2xl bg-slate-900/90 border border-cyan-500/30 text-left space-y-1.5">
              <div className="flex items-center justify-between text-cyan-400 font-bold">
                <span>01. USER</span>
                <UserCheck className="w-4 h-4" />
              </div>
              <div className="text-slate-100 font-sans font-semibold text-sm">Client Request</div>
              <div className="text-[11px] text-slate-400 font-sans">Browser interaction & form data</div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/90 border border-cyan-500/30 text-left space-y-1.5">
              ...
              <div className="text-slate-100 font-sans font-semibold text-sm">React.js & Tailwind</div>
              <div className="text-[11px] text-slate-400 font-sans">Dynamic state & UI rendering</div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/90 border border-indigo-500/30 text-left space-y-1.5">
              ...
              <div className="text-slate-100 font-sans font-semibold text-sm">Node.js & Express</div>
              <div className="text-[11px] text-slate-400 font-sans">RESTful API routes & business logic</div>
            </div>

            {/* Step 4: Database */}
            <div className="p-4 rounded-2xl bg-slate-900/90 border border-emerald-500/30 text-left space-y-1.5">
              <div className="flex items-center justify-between text-emerald-400 font-bold">
                <span>04. DATABASE</span>
                <Database className="w-4 h-4" />
              </div>
              <div className="text-slate-100 font-sans font-semibold text-sm">MongoDB & Mongoose</div>
              <div className="text-[11px] text-slate-400 font-sans">Persistent JSON document storage</div>
            </div>
          ...
          {skillCategories.map((cat, idx) => (
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-3">
                ...
                <span className={`text-[10px] font-mono px-2 py-0.5 rounded border bg-slate-900 ${cat.accent}`}>
                  {cat.badge}
                </span>
              </div>
